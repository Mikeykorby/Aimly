...
namespace Aimmy2.AILogic
{
    internal class AIManager : IDisposable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool IsTriggerArmed() =>
        ...
        {
            if (!Dictionary.toggleState["Auto Trigger"] || !IsTriggerArmed())
            {
                CheckSprayRelease();
                return;
            }
        ...
        private void CheckSprayRelease()
        {
            ...
            bool shouldSpray = Dictionary.toggleState["Auto Trigger"] && IsTriggerArmed();
