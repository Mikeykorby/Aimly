...
Aimly is 100% free to use. This means no ads, no key system, and no paywalled features. Aimly is not, and will never be for sale for the end user, and is considered a source-available product, and most of all, opensource.
